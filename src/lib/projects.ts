/* Portfolio projects. Single source for /portfolio/ and every case-study page.
   Only write what is true: every line was checked against the project itself.
   Leave a field out rather than guess. Screenshots live in public/images/work/. */

export type Status = "live" | "built" | "in-development" | "prototype";
export type Group = "websites" | "business" | "products";

export type Shot = { src: string; w: number; h: number; kind: "desktop" | "mobile"; alt: string };
...
export const projects: Project[] = [
  {
    ...
    "image": {
      "src": "/images/work/shiftreset-card.webp",
      "alt": "SHIFTRESET home page: “Reset what’s holding you back.”"
    },
    "gallery": [
      {
        "src": "/images/work/shiftreset-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "SHIFTRESET home page on desktop"
      },
      {
        "src": "/images/work/shiftreset-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "SHIFTRESET home page on a phone"
      }
    ],
    ...
    "features": [
      {
        ...
        "text": "24 questions, six areas, unit-tested scoring. The lowest-scoring area becomes the primary reset."
      },
      {
        "title": "Programs that run daily",
        "text": "Six programs with 92 daily actions, plus progress tracking and streaks."
      },
      {
        "title": "Payments and refunds",
        "text": "Tested end to end with a real payment and a real refund, including access removed on refund."
      },
      {
        "title": "Accessibility pass",
        "text": "Every text colour checked against every background for AA contrast; buttons and links at least 44 px."
      },
      {
        "title": "Honest guardrails",
        "text": "Clearly not a medical service, with scores presented as self-reflection, never as clinical measurement."
      }
    ],
    "tech": [
      "Next.js",
  ...
  },
  {
    ...
    "tagline": "The payments and enquiries backend behind thealtitudemindset.com, a coaching website.",
    "status": "live",
    ...
    "image": {
      "src": "/images/work/altitude-backend-card.webp",
      "alt": "The live checkout page: book a coaching or cabin crew session through Razorpay"
    },
    "gallery": [
      {
        "src": "/images/work/altitude-backend-desktop.webp",
        "w": 1200,
        "h": 650,
        "kind": "desktop",
        "alt": "Checkout page on desktop"
      },
      {
        "src": "/images/work/altitude-backend-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "Checkout page on a phone"
      }
    ],
    "previewNote": "The admin dashboard holds real enquiries, so only the public checkout is shown.",
    "problem": "A coaching website needed to take real payments for sessions and keep every enquiry in one place, without ever trusting a price sent from the browser.",
    "solution": "A small Node.js service on Netlify Functions with a Postgres database. It serves the checkout page, confirms every payment with Razorpay and keeps a copy of each enquiry sent from the site’s forms.",
    "layers": {
      ...
      "Integrations": "The coaching site’s contact and guide forms; Razorpay webhooks",
      "Deployment": "Netlify Functions on api.thealtitudemindset.com"
    },
    "features": [
      {
        "title": "Prices set on the server",
        "text": "The browser only names what it’s paying for; the amount always comes from the server."
      },
      {
        "title": "Webhooks that are safe to repeat",
        "text": "Each event is recorded before it’s processed, so a retry never double-counts, and a paid order is never downgraded."
      },
      {
        "title": "Rate limits that work serverless",
        "text": "Limits are stored in Postgres, because separate function instances share no memory."
      },
      {
        "title": "Locked-down browser access",
        "text": "Only the coaching site’s own addresses can call the API from a browser."
      },
      {
        "title": "Tested against a real database",
        "text": "50 automated tests run against Postgres, and the suite refuses to run on anything but a test database."
      }
    ],
    "tech": [
      "Node.js",
    ...
    "notYet": "",
    "experience": "A visitor picks a session on the checkout page and pays through Razorpay. Every enquiry from the site’s forms lands in one admin dashboard.",
    "decisions": [
    ...
    "features": [
      {
        ...
        "text": "Bills print as 80 mm receipts or A4 invoices in the brand’s own type and logo."
      },
      {
        "title": "Stock and materials",
        "text": "Material inventory and finished stock, each with required product details."
      },
      {
        "title": "Vendors and advances",
        "text": "A running record of vendors and the advances paid to them."
      },
      {
        "title": "Sync that never drops an edit",
        "text": "Devices refresh every 10 seconds and failed saves retry automatically. A refresh can’t overwrite an unsaved change, a bug found and fixed during testing."
      },
      {
        "title": "Garment swing tags",
        "text": "Print-ready 75 × 150 mm tags, with an optional product photo compressed on the device first."
      }
    ],
    "tech": [
      "HTML",
  ...
  },
  {
    ...
    "features": [
      {
        "title": "Repeat-order engine",
        "text": "Regular supplies are ranked by how often and how recently they were bought. Repeat the last order in one tap; any reorder is re-checked against stock."
      },
      {
        "title": "Fulfilment centres",
        "text": "Checkout reserves stock at the centre serving the customer, and delivery estimates respect opening hours."
      },
      {
        "title": "Loyalty and referrals",
        "text": "Points, referrals and saved recurring order lists."
      },
      {
        "title": "Delivery-agent view",
        "text": "A phone-first view for agents to work through and complete deliveries."
      },
      {
        "title": "Verified end to end",
        "text": "An order was placed as a customer, moved through fulfilment as an operator and completed as a delivery agent."
      }
    ],
    "tech": [
      "Next.js",
  ...
  },
  {
    ...
    "image": {
      "src": "/images/work/farm-ledger-card.webp",
      "alt": "Farm Ledger admin overview: farmer count, stock balance, sales, expenses and balance sheet"
    },
    "gallery": [
      {
        "src": "/images/work/farm-ledger-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "Farm Ledger admin overview on desktop, with a side menu and summary tiles"
      },
      {
        "src": "/images/work/farm-ledger-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "Farm Ledger’s Mark Attendance screen on a phone, with Present and Absent buttons for each farmer"
      }
    ],
    ...
    "features": [
      {
        ...
        "text": "Month-by-month attendance per farmer, with a calendar report."
      },
      {
        "title": "Wages and advances",
        "text": "Daily wage calculation, advance payments and balance sheets."
      },
      {
        "title": "Farm accounts",
        "text": "Expenses, sales, stock and an overall farm balance."
      },
      {
        "title": "Crop drying and job cards",
        "text": "A drying calendar and job cards for day-to-day operations."
      },
      {
        "title": "Offline queue",
        "text": "Advances, expenses, sales and stock can be recorded offline; a banner shows what is still waiting to sync."
      }
    ],
    "tech": [
      "React",
  ...
  },
  {
    ...
    "built": [
      "Customer & washer apps",
      "Nearest-washer dispatch",
    ...
    "features": [
      {
        "title": "Nearest-washer dispatch",
        "text": "Each booking is matched by distance, service radius and time-window conflicts."
      },
      {
        "title": "Booking lifecycle",
        "text": "Assigned, en route, in progress and completed, with the customer notified at every step."
      },
      {
        "title": "Subscriptions",
        "text": "An hourly job creates the next booking for every subscription that is due."
      },
      {
        "title": "Ratings",
        "text": "Customers rate the washer once a booking is complete."
      },
      {
        "title": "Notifications",
        "text": "Every update is saved in the app and also sent as a push notification when push is configured."
      }
    ],
    "tech": [
      "React Native",
    ...
    "features": [
      {
        ...
        "text": "Voice capture with a live input level meter."
      },
      {
        "title": "Transcription",
        "text": "Recordings become searchable text."
      },
      {
        "title": "Memory extraction",
        "text": "Memories and reminders are pulled out and de-duplicated, on the device or with cloud AI if the person opts in."
      },
      {
        "title": "Reminders and digest",
        "text": "Notifications, search, and a digest of what was captured."
      },
      {
        "title": "Audited",
        "text": "The Android app went through a 33-phase audit and a pass to fix what it found. Remaining gaps are written down, not hidden."
      }
    ],
    "tech": [
      "Kotlin",
  ...
  },
  {
    ...
    "image": {
      "src": "/images/work/course-tracker-card.webp",
      "alt": "Course Tracker: a navy spiral of aircraft, one per day, beside a habit list"
    },
    "gallery": [
      {
        "src": "/images/work/course-tracker-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "Course Tracker on desktop"
      },
      {
        "src": "/images/work/course-tracker-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "Course Tracker on a phone"
      }
    ],
    ...
    "features": [
      {
        ...
        "text": "Gold marks a flight day, green means 80% or more done, orange means partly done, and an outline means nothing ticked yet."
      },
      {
        "title": "Up to 60 habits",
        "text": "Add, reorder and remove habits. Habits added mid-month only count from the day they were added."
      },
      {
        "title": "Works offline",
        "text": "A service worker keeps the app available with no connection."
      },
      {
        "title": "Your data stays yours",
        "text": "No account and no server. Export to a file to carry your history to another device."
      },
      {
        "title": "On Android",
        "text": "A full-screen Android app with no browser bar."
      }
    ],
    "tech": [
      "HTML",
  ...
  },
  {
    ...
    "image": {
      "src": "/images/work/little-pilot-card.webp",
      "alt": "Little Pilot Academy’s Alphabet Runway: a letter grid with a picture, a sound and a tracing button for each letter"
    },
    "gallery": [
      {
        "src": "/images/work/little-pilot-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "The Alphabet Runway letter screen on desktop"
      },
      {
        "src": "/images/work/little-pilot-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "The Alphabet Runway letter screen on a phone"
      }
    ],
    ...
    "features": [
      {
        "title": "Four learning areas",
        "text": "Letters, words, numbers and reading."
      },
      {
        "title": "A guide to follow",
        "text": "Lumi and her fox lead the way through the app."
      },
      {
        "title": "No sign-up",
        "text": "An optional nickname is all it asks for."
      },
      {
        "title": "Made for small hands",
        "text": "Large, friendly controls designed for a young child on a tablet."
      }
    ],
    "tech": [
      "React",
  ...
  },
  {
    ...
    "image": {
      "src": "/images/work/deepika-brown-makeovers-card.webp",
      "alt": "Deepika Brown Makeovers home page: a bride in gold jewellery beside the line “Makeup that lasts as long as the celebration.”"
    },
    "gallery": [
      {
        "src": "/images/work/deepika-brown-makeovers-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "Deepika Brown Makeovers home page on desktop"
      },
      {
        "src": "/images/work/deepika-brown-makeovers-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "Deepika Brown Makeovers home page on a phone"
      }
    ],
    ...
    "features": [
      {
        ...
        "text": "A draggable line reveals a nail-art transformation. It also works with a swipe or the arrow keys."
      },
      {
        "title": "Lookbook",
        "text": "Recent work in a photo grid; any photo opens full size."
      },
      {
        "title": "One tap to call",
        "text": "A call button in the header and the contact section, plus a directions link that opens Google Maps."
      },
      {
        "title": "Built light",
        "text": "Photos are WebP, and all but the first screen’s are loaded only as they come into view."
      },
      {
        "title": "Respects motion settings",
        "text": "Scroll animations switch off for visitors who ask their device for reduced motion."
      }
    ],
    "tech": [
      "HTML",
  ...
  },
  {
    ...
    "liveLabel": "Open the website",
    "image": {
      "src": "/images/work/dijoo-afghan-cap-house-card.webp",
      "alt": "Dijoo Afghan Cap House home page: “Caps, jackets & leather for Kashmir winters” beside a stitched leather panel with an Afghan cap"
    },
    "gallery": [
      {
        "src": "/images/work/dijoo-afghan-cap-house-desktop.webp",
        "w": 1200,
        "h": 750,
        "kind": "desktop",
        "alt": "Dijoo Afghan Cap House home page on desktop"
      },
      {
        "src": "/images/work/dijoo-afghan-cap-house-mobile.webp",
        "w": 360,
        "h": 720,
        "kind": "mobile",
        "alt": "Dijoo Afghan Cap House home page on a phone"
      }
    ],
    ...
    "features": [
      {
        "title": "Lamp on the leather",
        "text": "With a mouse, a light follows the pointer across a stitched leather panel. It stays still on touch screens and for visitors who ask for reduced motion."
      },
      {
        "title": "A call bar for phones",
        "text": "Once the hero buttons scroll out of view, a bar with Call and Directions appears."
      },
      {
        "title": "Honest about what it doesn’t know",
        "text": "No prices or opening hours are invented. The page says stock and timings change and asks visitors to call before a special trip."
      },
      {
        "title": "Readable by search engines",
        "text": "schema.org ClothingStore data carries the address and phone number."
      },
      {
        "title": "Accessible basics",
        "text": "A skip link, visible keyboard focus, and reveal animations that switch off for reduced motion."
      }
    ],
    "tech": [
      "HTML",
